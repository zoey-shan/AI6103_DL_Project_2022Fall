...
class SkinDataset(Dataset):
    def __init__(self, skin_path: str, scale: float = 1.0, transform=None, **kwargs):
    ...
    def __getitem__(self, idx):
        ...
        # augmented images in tensor format should be converted into PIL image
        toImage = T.ToPILImage()
        img = toImage(img)
        lab = toImage(lab).convert("L")

        # the same preprocessing process rae done on both the image and masks after data augmentation    
